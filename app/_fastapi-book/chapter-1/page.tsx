...
import chapterContent from '../content/chapter-1.json';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8">
        ...
        <div id="main-content" className="max-w-4xl mx-auto space-y-12">
          <div className="flex justify-end mb-4">
            <ExportPDFButton chapterNumber={1} lang={lang} />
          </div>
        ...
        <div className="flex justify-between items-center mt-12 max-w-4xl mx-auto">
          ...
          >
            ...
            <span>{lang === 'en' ? 'Back to Book' : 'Volver al Libro'}</span>
          </Link>
          <Link
            href="/fastapi-book/chapter-2"
            className="flex items-center space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors"
          >
